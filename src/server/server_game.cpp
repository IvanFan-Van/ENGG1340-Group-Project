...
void ServerGame::handlePlayerAction(const Action &action, size_t bytes, int client_fd)
{
    ...
    default:
    {
        cout << "Invalid action type from client " << client_fd << ": " << action.type << endl;
        break;
    }
    }
}
...
void ServerGame::handleInitAction(const Action &action, int client_fd)
{
    ...
    cout << "player " << client_fd << " initialized the board successfully" << endl;
}
...
{
    cout << "Received shoot action from client " << client_fd << ": " << action.shootData.x << ", " << action.shootData.y << endl;
...
void ServerGame::handleGetGameStatusAction(const Action &action, int client_fd)
{
